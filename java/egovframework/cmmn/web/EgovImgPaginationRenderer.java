...
public class EgovImgPaginationRenderer extends AbstractPaginationRenderer {
    ...
    */
	public EgovImgPaginationRenderer() {
		...
		firstPageLabel = "<li class='paginate_button first disabled' id='dataTables-example_previous'><a href='#' onclick=\"{0}({1}); return false;\">처음페이지</a></li>";
		previousPageLabel = "<li class='paginate_button previous disabled' id='dataTables-example_previous'><a href='#' onclick=\"{0}({1}); return false;\">이전</a></li>";
		currentPageLabel = "<li class='paginate_button active'><a href='#'>{0}</a></li>";
		otherPageLabel = "<li class='paginate_button'><a href='#' onclick=\"{0}({1}); return false;\">{2}</a></li>";
		nextPageLabel = "<li class='paginate_button next' id='dataTables-example_next'><a href='#' onclick=\"{0}({1}); return false;\">다음</a></li>";
		lastPageLabel = "<li class='paginate_button last' id='dataTables-example_next'><a href='#' onclick=\"{0}({1}); return false;\">마지막페이지</a></li>";
