				...
				<div class="contents board list"><!-- 리스트형식 페이지에 검색이 있으면 "list" class 추가 -->
					...
					<table class="table table-bordered table-list">
						...
						<tbody>
							...
							<tr>
								<td>10</td>
								<td class="textL"><a href="#">[말머리] 자원봉사모집 글제목</a><img src="/images/front/common/ico_new.gif" alt="새글" class="img_ico"/></td>
								<td><span class="total">10</span></td>
								<td><span>10</span></td>
							...
							<tr>
								<td>9</td>
								<td class="textL"><a href="#">말머리 없을 수도 있음 자원봉사모집 글제목</a></td>
								<td><span class="total">10</span></td>
								<td><span>2</span></td>
								<td>2014/12/12~2014/12/12</td>
								<td>99999</td>
