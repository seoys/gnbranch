					...
					<fieldset>
						...
						<table class="table table-bordered table-write">
							...
							<tbody>
								<tr>
									...
									<td>
										<select name="" id="" class="form-control">
											<option value="">아동보호전문기관</option>
										</select>
									</td>
								</tr>
								<tr>
									<th scope="row">지부명</th>
									<td><input type="text" class="form-control"><button class="btn btn-form">중복확인</button></td>
								</tr>
								<tr>
									<th scope="row">지부 홈페이지 URL</th>
									<td>http:// <input type="text" class="form-control">.goodneighbors.kr</td>
								</tr>
								<tr>
									<th scope="row">ID / PASS</th>
									<td><label for="">ID</label> : admin <input type="text" id="" class="form-control"/><label for="" class="mgl15">PASS</label> : <input type="text" id="" class="form-control"/> <span class="s_text">영문, 숫자, 특수문자 혼합 8~12자리</span></td>
								</tr>
								<tr>
								...
								<tr>
									<th scope="col">교통편</th>
									<td><textarea name="" id="" rows="5" class="form-control col-unit12"></textarea></td>
								</tr>
								<tr>
